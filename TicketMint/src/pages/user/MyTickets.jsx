  ...
  : <h1 className='dark:text-white text-[0b0b1c]'>No events</h1> 
    ...
    return (
      <main className=' flex flex-1 gap-6 flex-col desktop:mt-20 items-center mb-20 min-h-screen'>
          <h2 className='text-lg dark:text-white text-[#0b0b1c]  font-bold py-1 desktop:text-center desktop:w-[70%] desktop:text-5xl movil:mt-5 movil:text-2xl laptop:mt-0'>My Tickets</h2>
