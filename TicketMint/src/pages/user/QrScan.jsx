  ...
  return (
    <div className='bg-[#0b0b1c] flex flex-1 p-3 gap-6 desktop:mt-20 flex-col items-center'>
        ...
        <div className='flex flex-col items-center'>
            ...
            <p className='text-white opacity-90'  onClick={handleTap}>Present QR on scanner</p>
        </div>
        ...
        <div>
            <p className='text-white opacity-60 w-[185px] text-center'>This code is unique and will be deactivated once scanned.</p>
        </div>
    </div>
  )
}
