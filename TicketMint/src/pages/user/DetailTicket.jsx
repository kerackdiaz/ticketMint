...
function DetailTicket() {
  ...
  return (
    <div className='bg-[#0b0b1c] p-4 flex flex-1 gap-5 flex-col desktop:mt-20 items-center'>
        ...
        <CardMyTickets key={eventTicket.id} name={eventTicket.name} date={eventTicket.date} image={eventTicket.imageURL} id={eventTicket.id} ticketCount={eventTicket.ticketCount}/>
        ...
        <Link to={`/scan/${ticket.id}`} className='w-full flex justify-center md:w-1/2 xl:w-1/3 desktop:mt-40'>
