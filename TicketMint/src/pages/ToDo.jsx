...
const TodoApp = () => {
  ...
  return (
    <div className="lg:w-[65%] relative lg:left-[15%] md:left-[25%] md:w-1/2 w-[80%] h-[80%] top-32 right-8 py-6 px-6 rounded-xl border border-gray-200  mt-10 flex flex-wrap gap-10">

    <div className="w-full h-[80%]  shadow-lg rounded-md lg:w-[55%] lg:ml-44">
      <div className="bg-white p-3  ">
        <div className="text-center">
          <h1 className="text-3xl font-bold">ToDo App</h1>
          <div className="mt-4 flex lg:pl-16 ">
            <input
              ref={newTaskRef}
              className="lg:w-[400px] w-[200px] md:w-[300px] border-b-2 border-gray-500 text-black"
              type="text"
