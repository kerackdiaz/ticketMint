...
const NewEvent = () => {
  return (
    <div className="lg:w-[65%] relative lg:left-[15%] md:left-[25%] md:w-1/2 w-[80%] h-[80%] top-32 right-8 py-6 px-6 rounded-xl border border-gray-200 bg-white mt-10 flex flex-wrap gap-10">
      ...
      <div class=" h-screen flex flex-wrap items-center justify-center px-5 rounded-xl border border-gray-200 bg-morado4 opacity-85 w-[80%] md:w-[900px] lg:w-[50%]">
      <button className="absolute top-10 left-10">
        ...
        <div class="flex flex-col w-full md:flex-row">
          <div class="flex flex-row justify-around p-4 font-bold leading-none text-gray-800 uppercase bg-pink rounded md:flex-col md:items-center md:justify-center md:w-1/4">
            <div class="md:text-3xl">New</div>
            {/* <div class="md:text-6xl">Date</div> */}
            <div class="md:text-xl">Date</div>
          </div>
