...
function CardMyTickets() {
  return (
    <Link to={`/detailTicket/${1}`}>
      <div className='bg-[url(/prueba.png)] bg-top bg-local rounded-2xl flex flex-col justify-end  w-[343px] h-64'>
          <div className='h-28 bg-[#523276] opacity-90 w-full rounded-b-2xl flex justify-between px-2 py-1'>
                  <div className=' items-start opacity-90 '>
                      ...
                      <p className='text-white text-sm items-center flex gap-1'><IoLocationOutline /> 19th Street Event Center</p>
