...
const Layout = () => {
  ...
  return (
    <>
      <nav class="fixed top-0 z-50 w-full bg-white border-b border-morado3 dark:bg-gray-800 dark:border-gray-700">
        <div class="px-3 py-3 lg:px-5 lg:pl-3 " r>
          <div class="flex items-center justify-between h-[100px] ">
            <div class="flex items-center justify-start rtl:justify-end">
              ...
              <a
                ...
                class="flex ms-2 md:me-24 w-[100px]"
              >
                <svg
                  width="180"
                  height="180"
              ...
              <Link to="/Message">
                <svg
                  className="lg:ml-[600px] hidden lg:block md:block md:ml-[370px]"
                  width="47px"
                  height="47px"
      ...
      <aside
        id="logo-sidebar"
        class="fixed  top-0 left-0 z-40 w-64 md:w-52 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-morado3 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar"
      >
        <div class="mt-[90px] bottom-64 px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
