...
const Layout = () => {
  ...
  return (
    <>
      ...
      <aside
        id="logo-sidebar"
        class="fixed  top-0 left-0 z-40 w-64 tablet:w-52 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-morado3 movil:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
        aria-label="Sidebar"
      >
