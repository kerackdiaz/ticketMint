...
const Balance = () => {
    ...
    <Chart2 />
      <div className="w-full px-6 py-6 mx-auto loopple-min-height-78vh text-slate-500  ">
        <div className="flex flex-wrap flex-col -mx-3 removable latptop:flex-row ">
          <div className="w-full max-w-full px-3 movil:w-1/2 movil:flex-none xl:mb-0 xl:w-1/4">
          ...
          <div className="w-full max-w-full px-3 movil:w-1/2 movil:flex-none xl:w-1/4">
            <div className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border mb-4">
            <div className="flex-auto border-2 p-5 rounded-xl shadow-lg  tablet:w-[200px]">
                <div className="flex flex-row -mx-3">
                  <div className="flex-none w-2/3 max-w-full px-3">
