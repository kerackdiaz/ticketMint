                  ...
                  <div className="flex-none w-2/3 max-w-full ">
                    <div>
                      ...
                      <h5 className="mb-0 text-center font-bold">
                        {" "}
                        {sales.events.length}{" "}
                        <span className="leading-normal invisible text-sm font-weight-bolder text-lime-500 p-5">
                          +55%
                        </span>
                      </h5>
                    </div>
                  ...
                  <div className="flex-none w-2/3 max-w-full px-3">
                    <div>
                      ...
                      <h5 className="mb-0 font-bold">
                        {" "}
                        +3,462{" "}
                        <span className="leading-normal text-red-600 hidden text-sm font-weight-bolder p-5">
                          -2%
                        </span>
                      </h5>
                    </div>
